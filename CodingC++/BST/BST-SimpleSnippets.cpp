...
public:
    ...
    int sumOfNodes(TreeNode* r)
    {
        ...
        return r->value+sumOfNodes(r->left)+sumOfNodes(r->right);
    }
...
int main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            break;
        case 4:
            obj.printGivenLevel(obj.root, 2);
            // cout << "PRINT 2D: " << endl;
        ...
        case 7:
            ...
            int level;
            cin >> level;
            cout << obj.sumOfLevel(obj.root, level);
            break;
        ...
        case 9:
            cout<<obj.sumOfNodes(obj.root)<<endl;
            break;
